...
opcodes = {
    "adc": (AddressMode.immediate  , 0x69),
    "adc": (AddressMode.zeropage   , 0x65),
    "adc": (AddressMode.zeropage_x , 0x75),
    "adc": (AddressMode.absolute   , 0x6d),
    "adc": (AddressMode.absolute_x , 0x7d),
    "adc": (AddressMode.absolute_y , 0x79),
    "adc": (AddressMode.indirect_x , 0x61),
    "adc": (AddressMode.indirect_y , 0x71),
    "and": (AddressMode.immediate  , 0x29),
    "and": (AddressMode.zeropage   , 0x25),
    "and": (AddressMode.zeropage_x , 0x35),
    "and": (AddressMode.absolute   , 0x2d),
    "and": (AddressMode.absolute_x , 0x3d),
    "and": (AddressMode.absolute_y , 0x39),
    "and": (AddressMode.indirect_x , 0x21),
    "and": (AddressMode.indirect_y , 0x31),
    "asl": (AddressMode.accumulator, 0x0a),
    "asl": (AddressMode.zeropage   , 0x06),
    "asl": (AddressMode.zeropage_x , 0x16),
    "asl": (AddressMode.absolute   , 0x0e),
    "asl": (AddressMode.absolute_x , 0x1e),
    "bcc": (AddressMode.relative   , 0x90),
    "bcs": (AddressMode.relative   , 0xb0),
    "beq": (AddressMode.relative   , 0xf0),
    "bit": (AddressMode.zeropage   , 0x24),
    "bit": (AddressMode.absolute   , 0x2c),
    ...
    "bvc": (AddressMode.relative   , 0x70),
    "clc": (AddressMode.implied    , 0x18),
    "cld": (AddressMode.implied    , 0xd8),
    "cli": (AddressMode.implied    , 0x58),
    "clv": (AddressMode.implied    , 0xb8),
    "cmp": (AddressMode.immediate  , 0xc9),
    "cmp": (AddressMode.zeropage   , 0xc5),
    "cmp": (AddressMode.zeropage_x , 0xd5),
    "cmp": (AddressMode.absolute   , 0xcd),
    "cmp": (AddressMode.absolute_x , 0xdd),
    "cmp": (AddressMode.absolute_y , 0xd9),
    "cmp": (AddressMode.indirect_x , 0xc1),
    "cmp": (AddressMode.indirect_y , 0xd1),
    "cpx": (AddressMode.immediate  , 0xe0),
    "cpx": (AddressMode.zeropage   , 0xe4),
    "cpx": (AddressMode.absolute   , 0xec),
    "cpy": (AddressMode.immediate  , 0xc0),
    "cpy": (AddressMode.zeropage   , 0xc4),
    "cpy": (AddressMode.absolute   , 0xcc),
    "dec": (AddressMode.zeropage   , 0xc6),
    "dec": (AddressMode.zeropage_x , 0xd6),
    "dec": (AddressMode.absolute   , 0xce),
    "dec": (AddressMode.absolute_x , 0xde),
    "dec": (AddressMode.implied    , 0xca),
    "dec": (AddressMode.implied    , 0x88),
    "eor": (AddressMode.immediate  , 0x49),
    "eor": (AddressMode.zeropage   , 0x45),
    "eor": (AddressMode.zeropage_x , 0x55),
    "eor": (AddressMode.absolute   , 0x4d),
    "eor": (AddressMode.absolute_x , 0x5d),
    "eor": (AddressMode.absolute_y , 0x59),
    "eor": (AddressMode.indirect_x , 0x41),
    "eor": (AddressMode.indirect_y , 0x51),
    "inc": (AddressMode.zeropage   , 0xe6),
    "inc": (AddressMode.zeropage_x , 0xf6),
    "inc": (AddressMode.absolute   , 0xee),
    "inc": (AddressMode.absolute_x , 0xfe),
    "inx": (AddressMode.implied    , 0xe8),
    "iny": (AddressMode.implied    , 0xc8),
    "jmp": (AddressMode.absolute   , 0x4c),
    "jmp": (AddressMode.indirect   , 0x6c),
    "jsr": (AddressMode.absolute   , 0x20),
    "lda": (AddressMode.immediate  , 0xa9),
    "lda": (AddressMode.zeropage   , 0xa5),
    "lda": (AddressMode.zeropage_x , 0xb5),
    "lda": (AddressMode.absolute   , 0xad),
    "lda": (AddressMode.absolute_x , 0xbd),
    "lda": (AddressMode.absolute_y , 0xb9),
    "lda": (AddressMode.indirect_x , 0xa1),
    "lda": (AddressMode.indirect_y , 0xb1),
    "ldx": (AddressMode.immediate  , 0xa2),
    "ldx": (AddressMode.zeropage   , 0xa6),
    "ldx": (AddressMode.zeropage_y , 0xb6),
    "ldx": (AddressMode.absolute   , 0xae),
    "ldx": (AddressMode.absolute_y , 0xbe),
    "ldy": (AddressMode.immediate  , 0xa0),
    "ldy": (AddressMode.zeropage   , 0xa4),
    "ldy": (AddressMode.zeropage_x , 0xb4),
    "ldy": (AddressMode.absolute   , 0xac),
    "ldy": (AddressMode.absolute_x , 0xbc),
    "lsr": (AddressMode.accumulator, 0x4a),
    "lsr": (AddressMode.zeropage   , 0x46),
    "lsr": (AddressMode.zeropage_x , 0x56),
    "lsr": (AddressMode.absolute   , 0x4e),
    "lsr": (AddressMode.absolute_x , 0x5e),
    "nop": (AddressMode.implied    , 0xea),
    "ora": (AddressMode.immediate  , 0x09),
    "ora": (AddressMode.zeropage   , 0x05),
    "ora": (AddressMode.zeropage_x , 0x15),
    "ora": (AddressMode.absolute   , 0x0d),
    "ora": (AddressMode.absolute_x , 0x1d),
    "ora": (AddressMode.absolute_y , 0x19),
    "ora": (AddressMode.indirect_x , 0x01),
    "ora": (AddressMode.indirect_y , 0x11),
    "pha": (AddressMode.implied    , 0x48),
    "php": (AddressMode.implied    , 0x08),
    "pla": (AddressMode.implied    , 0x68),
    "plp": (AddressMode.implied    , 0x28),
    "rol": (AddressMode.accumulator, 0x2a),
    "rol": (AddressMode.zeropage   , 0x26),
    "rol": (AddressMode.zeropage_x , 0x36),
    "rol": (AddressMode.absolute   , 0x2e),
    "rol": (AddressMode.absolute_x , 0x3e),
    "ror": (AddressMode.accumulator, 0x6a),
    "ror": (AddressMode.zeropage   , 0x66),
    "ror": (AddressMode.zeropage_x , 0x76),
    "ror": (AddressMode.absolute   , 0x6e),
    "ror": (AddressMode.absolute_x , 0x7e),
    "rti": (AddressMode.implied    , 0x40),
    "rts": (AddressMode.implied    , 0x60),
    "sbc": (AddressMode.immediate  , 0xe9),
    "sbc": (AddressMode.zeropage   , 0xe5),
    "sbc": (AddressMode.zeropage_x , 0xf5),
    "sbc": (AddressMode.absolute   , 0xed),
    "sbc": (AddressMode.absolute_x , 0xfd),
    "sbc": (AddressMode.absolute_y , 0xf9),
    "sbc": (AddressMode.indirect_x , 0xe1),
    "sbc": (AddressMode.indirect_y , 0xf1),
    "sec": (AddressMode.implied    , 0x38),
    "sed": (AddressMode.implied    , 0xf8),
    "sei": (AddressMode.implied    , 0x78),
    "sta": (AddressMode.zeropage   , 0x85),
    "sta": (AddressMode.zeropage_x , 0x95),
    "sta": (AddressMode.absolute   , 0x8d),
    "sta": (AddressMode.absolute_x , 0x9d),
    "sta": (AddressMode.absolute_y , 0x99),
    "sta": (AddressMode.indirect_x , 0x81),
    "sta": (AddressMode.indirect_y , 0x91),
    "stx": (AddressMode.zeropage   , 0x86),
    "stx": (AddressMode.zeropage_y , 0x96),
    "stx": (AddressMode.absolute   , 0x8e),
    "sty": (AddressMode.zeropage   , 0x84),
    "sty": (AddressMode.zeropage_x , 0x94),
    "sty": (AddressMode.absolute   , 0x8c),
